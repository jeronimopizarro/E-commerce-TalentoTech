...
public class Main {
        ...
        do {
            ...
            switch (opcionElegida) {
                ...
                case 3:
                    ...
                    scanner.nextLine(); //Esto esta raro, tengo que limpiar el buffer
                ...
                case 4:
                    ...
                    verificarModificacion(productoAEliminar, scanner, productos);
                    break;
    ...
    private static void verificarModificacion(Producto productoAEliminar, Scanner scanner, ArrayList<Producto> productos) {
    ...
    private static ArrayList<Producto> filtrarProductosPorNombre(Scanner scanner, ArrayList<Producto> productos) {
        ArrayList<Producto> encontrados = obtenerProductosPorNombre(scanner, productos);
